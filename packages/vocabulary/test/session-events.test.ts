...
test('the vocabulary holds the 12 core events plus governance, compaction, and asks', () => {
  assert.equal(KNOWN_SESSION_EVENT_TYPES.length, 16)
  assert.equal(new Set(KNOWN_SESSION_EVENT_TYPES).size, 16)
