import { Context, Service, type Plugin } from '@sudive-ai/cordis'
import type { Dict } from '@sudive-ai/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@sudive-ai/cordis-plugin-loader'
import type { Include } from '@sudive-ai/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@sudive-ai/cordis-plugin-timer'
import { fileURLToPath, pathToFileURL } from 'node:url'
import { createRequire } from 'node:module'
import picomatch from 'picomatch'
import z from '@sudive-ai/schemastery'
